...
/* PCF8574A */
#define PCF8574A_ADDRESS 0x27 /* I2C slave device */
/* PCF8574A connections to LCD */
//#define PCF8574A_D7 0x80
//#define PCF8574A_D6 0x40
//#define PCF8574A_D5 0x20
//#define PCF8574A_D4 0x10
#define PCF8574A_BL 0x08 /* Backlight */
#define PCF8574A_EN 0x04 /* Enable bit */
#define PCF8574A_RW 0x02 /* Read/Write bit (0 = write) */
#define PCF8574A_RS 0x01 /* Register select bit */
/******************************************************************************\
...
void LCD1602_Init(void) {																																		
	...
	PCF8574A_Write(0x00);																										
	DELAY(42)												/* >15ms */
	LCD1602_Write4(0x33,0);					/* 4-bit interface */								
...
void PCF8574A_Write(uint8_t data) {
	...
	I2C_Write(PCF8574A_ADDRESS, data | (lcd_backlight?PCF8574A_BL:0x00));
}
/**
...
void LCD1602_Write4(uint8_t data, uint8_t rs) {
	...
	PCF8574A_Write(((data << 4)&0xF0) | (rs?PCF8574A_RS:0x00) | PCF8574A_EN);
	PCF8574A_Write(((data << 4)&0xF0) | (rs?PCF8574A_RS:0x00));
	DELAY(2)
}
/**
